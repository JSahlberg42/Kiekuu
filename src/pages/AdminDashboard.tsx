        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 sm:p-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="ml-4 text-lg sm:text-xl font-semibold text-orange-500 uppercase tracking-wide">Teams</h2>
            </div>
            <p className="text-sm sm:text-base leading-relaxed text-slate-300 mb-4">Manage teams and their members</p>
            <Link
              to="/admin/teams"
              className="block w-full bg-orange-500 text-slate-50 px-4 py-3 rounded-xl hover:bg-orange-600 active:bg-orange-700 transition-colors font-semibold min-h-[44px] text-center"
              aria-label="Hallitse joukkueita"
            >
              Manage Teams
            </Link>
          </div>
