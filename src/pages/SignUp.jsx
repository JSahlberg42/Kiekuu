  ...
  const getErrorMessage = (code) => {
    switch (code) {
      ...
      case 'auth/operation-not-allowed':
        return 'Rekisteröityminen ei ole käytössä';
      case 'auth/weak-password':
        return 'Salasana on liian heikko';
      default:
        return 'Rekisteröityminen epäonnistui. Yritä uudelleen.';
    }
  };
      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 sm:mt-8 space-y-4 sm:space-y-6 bg-slate-900 border border-slate-800 rounded-xl p-6 sm:p-8" role="form" aria-label="Rekisteröitymislomake">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs font-medium uppercase tracking-widest text-slate-400 mb-2">
                Vahvista salasana
              </label>
              <input
                id="confirmPassword"
